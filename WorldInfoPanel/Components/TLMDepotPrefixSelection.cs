...
namespace Klyte.TransportLinesManager.WorldInfoPanelExt.Components
{
    internal class TLMDepotPrefixSelection<TSD> : MonoBehaviour where TSD : TLMSysDef<TSD>
    {
        ...
        {
            KlyteMonoUtils.CreateUIElement(out m_addAllPrefixesButton, m_mainPanel.transform);
            ...
            KlyteMonoUtils.InitButton(m_addAllPrefixesButton, true, "ButtonMenu");
            ...
            KlyteMonoUtils.CreateUIElement(out m_removeAllPrefixesButton, m_mainPanel.transform);
            ...
            KlyteMonoUtils.InitButton(m_removeAllPrefixesButton, true, "ButtonMenu");
