...
namespace Klyte.TransportLinesManager.OptionsMenu
{
    internal class TLMShowConfigTab<T> : UICustomControl where T : TLMSysDef<T>
    {
        ...
        private void Awake()
        {
            ...
            m_vehicleNumberFormatLocal = m_tlmCo.GenerateTextFieldConfigNew(m_uiHelper, Locale.Get("K45_TLM_NUMBERVEHICLEPATTERN_LOCAL"), transportType | TLMConfigWarehouse.ConfigIndex.VEHICLE_NUMBER_FORMAT_LOCAL);
            m_vehicleNumberFormatForeign = m_tlmCo.GenerateTextFieldConfigNew(m_uiHelper, Locale.Get("K45_TLM_NUMBERVEHICLEPATTERN_FOREIGN"), transportType | TLMConfigWarehouse.ConfigIndex.VEHICLE_NUMBER_FORMAT_FOREIGN);
            m_uiHelper.AddSpace(5);
            ...
            DefaultEditorUILib.AddButtonInEditorRow(m_vehicleNumberFormatLocal, CommonsSpriteNames.K45_QuestionMark, Help_VehicleNumberFormat, null, true, 30);
            DefaultEditorUILib.AddButtonInEditorRow(m_vehicleNumberFormatForeign, CommonsSpriteNames.K45_QuestionMark, Help_VehicleNumberFormat, null, true, 30);
