...
namespace Klyte.TransportLinesManager.MapDrawer
{
    public class TLMMapHtmlTemplate
    {
        ...
        /// 1 = Width
        /// </summary>
        public string GetHtmlHeader(TLMMapCityTransportObject cto) => $@"
            ...
            <div id=""mapContainer"" style=""    width: calc(100% - 410px); overflow: auto;    position: absolute;"">
                 <svg id=""map"">
                 <defs>
    ...
    <div id=""date"">{date.ToString(CultureInfo.GetCultures(CultureTypes.SpecificCultures).Where(c => c.TwoLetterISOLanguageName == KlyteLocaleManager.CurrentLanguageId).FirstOrDefault())}</div>
    <div id=""content"">
</div></body></html>";
