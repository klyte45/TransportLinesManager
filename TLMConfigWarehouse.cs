 ...
 public class TLMConfigWarehouse : ConfigWarehouseBase<TLMConfigWarehouse.ConfigIndex, TLMConfigWarehouse>
   {
       ...
       public static string getNameForTransportType(ConfigIndex i)
       {
           switch (i & ConfigIndex.SYSTEM_PART)
           {
               case ConfigIndex.TRAIN_CONFIG:                   return Locale.Get("VEHICLE_TITLE", "Train Engine");
               case ConfigIndex.TRAM_CONFIG:                   return Locale.Get("VEHICLE_TITLE", "Tram");
               case ConfigIndex.METRO_CONFIG:                   return Locale.Get("VEHICLE_TITLE", "Metro");
               case ConfigIndex.BUS_CONFIG:                   return Locale.Get("VEHICLE_TITLE", "Bus");
               case ConfigIndex.PLANE_CONFIG:                   return Locale.Get("VEHICLE_TITLE", "Aircraft Passenger");
               case ConfigIndex.SHIP_CONFIG:                   return Locale.Get("VEHICLE_TITLE", "Ship Passenger");
               case ConfigIndex.BLIMP_CONFIG:                   return Locale.Get("VEHICLE_TITLE", "Blimp");
               case ConfigIndex.FERRY_CONFIG:                   return Locale.Get("VEHICLE_TITLE", "Ferry");
               case ConfigIndex.MONORAIL_CONFIG:                   return Locale.Get("VEHICLE_TITLE", "Monorail Front");
               case ConfigIndex.EVAC_BUS_CONFIG:                   return Locale.Get("VEHICLE_TITLE", "Evacuation Bus");
               case ConfigIndex.TOUR_BUS_CONFIG:                   return Locale.Get("TOOLTIP_TOURISTBUSLINES");
               case ConfigIndex.TOUR_PED_CONFIG:                   return Locale.Get("TOOLTIP_WALKINGTOURS");
               case ConfigIndex.CABLE_CAR_CONFIG:                   return Locale.Get("VEHICLE_TITLE", "Cable Car");
               case ConfigIndex.TAXI_CONFIG:                   return Locale.Get("VEHICLE_TITLE", "Taxi");
               case ConfigIndex.HELICOPTER_CONFIG:                   return Locale.Get("VEHICLE_TITLE", "Passenger Helicopter");
               case ConfigIndex.TROLLEY_CONFIG:                   return Locale.Get("VEHICLE_TITLE", "Trolleybus 01");
               default:                                            return "???";
           }
       }
       ...
       public static TransferManager.TransferReason[] getTransferReasonFromSystemId(ConfigIndex idx)
       {
           ...
           switch (systemIdx)
           {
               ...
               case ConfigIndex.TROLLEY_CONFIG:                   return new TransferManager.TransferReason[] { TransferManager.TransferReason.Trolleybus };
               case ConfigIndex.HELICOPTER_CONFIG:                   return new TransferManager.TransferReason[] { TransferManager.TransferReason.PassengerHelicopter };
       ...
       public static readonly ConfigIndex[] namingOrder =
       {
           ...
           ConfigIndex.NATURAL_SERVICE_CONFIG   ,
           ConfigIndex.VARSITY_SPORTS_SERVICE_CONFIG   ,
           ConfigIndex.MUSEUMS_SERVICE_CONFIG   ,
           ConfigIndex.PLAYER_EDUCATION_SERVICE_CONFIG   ,
           ConfigIndex.PLAYER_INDUSTRY_SERVICE_CONFIG  ,
           ...
           ConfigIndex.FIREDEPARTMENT_SERVICE_CONFIG    ,
           ConfigIndex.GARBAGE_SERVICE_CONFIG   ,
           ConfigIndex.WATER_SERVICE_CONFIG ,
           ConfigIndex.ELECTRICITY_SERVICE_CONFIG   ,
           ConfigIndex.ROAD_SERVICE_CONFIG  ,
           ConfigIndex.OFFICE_SERVICE_CONFIG    ,
           ConfigIndex.TOURISM_SERVICE_CONFIG   ,
           ConfigIndex.CITIZEN_SERVICE_CONFIG   ,
           ConfigIndex.INDUSTRIAL_SERVICE_CONFIG    ,
           ConfigIndex.COMMERCIAL_SERVICE_CONFIG    ,
           ConfigIndex.RESIDENTIAL_SERVICE_CONFIG   ,
       };
